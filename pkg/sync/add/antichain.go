...
func Unit(dag gomel.Dag, randomSource gomel.RandomSource, preunit gomel.Preunit, fallback gsync.QueryServer, log zerolog.Logger) error {
...
func Antichain(dag gomel.Dag, randomSource gomel.RandomSource, preunits []gomel.Preunit, fallback gsync.QueryServer, log zerolog.Logger) *AggregateError {
	var wg sync.WaitGroup
