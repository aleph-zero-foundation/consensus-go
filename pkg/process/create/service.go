...
func NewService(poset gomel.Poset, config *process.Create, posetFinished chan<- struct{}, primeUnitCreated chan<- struct{}, txSource <-chan *gomel.Tx, log zerolog.Logger) (process.Service, error) {
	return &service{
